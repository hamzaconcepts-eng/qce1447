                          ...
                          <tr key={result.id}>
                            ...
                            <td>
                              <span style={{
                                ...
                                fontSize: '12px',
                                fontWeight: '700',
                                background: result.final_score >= 95 ? '#d4edda' : 
                                           result.final_score >= 90 ? '#fff3cd' : 
                                           result.final_score >= 80 ? '#d1ecf1' :
                                           result.final_score >= 60 ? '#e2e3e5' : '#f8d7da',
                                color: result.final_score >= 95 ? '#27ae60' : 
                                      result.final_score >= 90 ? '#f39c12' : 
                                      result.final_score >= 80 ? '#3498db' :
                                      result.final_score >= 60 ? '#6c757d' : '#e74c3c'
                              }}>
                                {result.final_score}
                              </span>
                            </td>
                            <td style={{ fontSize: '11px', color: '#666' }}>{result.tanbih_count}</td>
                            <td style={{ fontSize: '11px', color: '#666' }}>{result.fateh_count}</td>
                            <td style={{ fontSize: '11px', color: '#666' }}>{result.tashkeel_count}</td>
                            <td style={{ fontSize: '11px', color: '#666' }}>{result.tajweed_count}</td>
                          </tr>
                        ))}
                      </tbody>
                    </table>
